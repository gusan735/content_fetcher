<h1>Introduktion</h1>
Början på en resa. Målsättning: en webbtjänst med ett syfte. Att på ett datadrivet, automatiserat och lättillgängligt sätt visa det content du är intresserad av. Låtsas att stora näthjättarna inte är annat än stora datakällor -> hur skulle du gå tillväga för att bygga en bättre upplevelse? Let's find out!
